...
<div class="card mb-3">
    ...
    <div class="card-body" id="hideshow">
        ...
        <div class="col-lg-7 ms-auto me-auto">
            <form method="post" action="{{ url('dashboard/data_biaya_khusus/'.$data_biaya_khusus->id) }}">
            @csrf
            @method('PUT')
            <div class="mb-3">
                ...
                <div class="col-sm-5">
                    <div class="input-group mb-3">
                      ...
                      <input type="date" class="form-control @error(' tgl_proses') is-invalid @enderror" name=" tgl_proses" id="tgl_proses" value="{{ old('tgl_proses', date('Y-m-d')) }}">
                    </div>                          
                </div>
                @error('tgl_proses')    
            ...
            <div class="mb-3">
                ...
                <textarea type="text" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" required value="{{ old('keterangan') }}">{{ old('keterangan' , $data_biaya_khusus->keterangan) }}</textarea>
                @error('keterangan')    
                  <div class="invalid-feedback">
                      {{ $message }}
                  </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('karyawan') is-invalid @enderror" id="karyawan" name="karyawan" required  value="{{ old('karyawan', $data_biaya_khusus->karyawan)  }}">
              @error('karyawan')    
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="decimal" class="form-control @error('biaya') is-invalid @enderror" id="biaya" name="biaya"  required  value="{{ old('biaya', $data_biaya_khusus->biaya)  }}" aria-label="Amount (to the nearest dollar)">
            ...
            <div class="mb-3">
                ...
                <select id="unitkerja_id" class="form-select" name="unitkerja_id" required>
                    ...
                    @if(old('unitkerja_id', $data_biaya_khusus->unitkerja_id) == $unitkerja->id)
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('periode') is-invalid @enderror" id="periode" name="periode" required  value="{{ old('periode', $data_biaya_khusus->periode)  }}">
                @error('periode')    
                  <div class="invalid-feedback">
                      {{ $message }}
                  </div>
              ...
              <div class="mb-3">
                ...
                <textarea type="text" class="form-control @error('kegiatan') is-invalid @enderror" id="kegiatan" name="kegiatan" required value="{{ old('kegiatan') }}">{{ old('kegiatan' , $data_biaya_khusus->kegiatan) }}</textarea>
                @error('kegiatan')    
                  <div class="invalid-feedback">
                      {{ $message }}
                  </div>
