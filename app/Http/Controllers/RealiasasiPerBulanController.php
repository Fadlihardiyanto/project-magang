...
class RealiasasiPerBulanController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            ->rawColumns(['unitkerja_name', 'tahun_anggaran', 'total_anggaran', 'total_realisasi', 'sisa_saldo'])
            ->make(true);
        }
        ...
        return view('dashboard.realisasi_per_bulan.index', compact('data', 'tahuns', 'anggaran', 'unitkerjas'));
    }
