    ...
    <div class="card-body" id="hideshow">
          <div class="card">
            <div class="card-header text-bg-primary">
                <span data-feather="dollar-sign" class="align-text-bottom"></span> Realisasi Per Tahun
            </div>
            <div class="card-body">
                <div>
                ...
                <div>
                    <h5 class="text-center">RKAP Per Tahun</h5>
                    ...
                    <table class="table table-responsive table-light table-striped table-bordered table-hover mt-3 user_datatable" >
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" class="text-center col-2">Total Realisasi (Rp)</th>
                                <th rowspan="2" class="text-center border col-2">Sisa Saldo (Rp)</th>
                            </tr>
                            <tr>
                                <th class="text-center ">TW I (Rp)</th>
                                <th class="text-center">TW II (Rp)</th>
                                <th class="text-center">TW III (Rp)</th>
                                <th class="text-center">TW IV (Rp)</th>
                            </tr>
                        </thead>
...
<script type="text/javascript">
    ...
    $(function () {
      ...
      var table = $('.user_datatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('pertahun.index') }}",
          "dom": "Blfrtip",
                    "buttons": [
                        {
                        extend : 'print',
                        title : 'RKAP Per Tahun',
                        footer: true,
