...
<div class="card mb-3">
    ...
    <div class="card-body" id="hideshow">
        ...
        <div class="col-lg-7 ms-auto me-auto">
            <form method="post" action="{{ url('dashboard/hotel/'.$hotel->id) }}">
            @csrf
            @method('PUT')
            <div class="mb-3 d-flex">
              <label class="p-2 col-2 fw-bold" for="name" class="form-label">Nama Hotel</label>
              <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" required value="{{ old('name', $hotel->name) }}">
              @error('name')    
            ...
            <div class="mb-3 d-flex">
              ...
              <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" required value="{{ old('email', $hotel->email) }}">
              @error('email')    
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3 d-flex">
              ...
              <input type="text" class="form-control @error('cp') is-invalid @enderror" id="cp" name="cp" required value="{{ old('cp', $hotel->cp) }}">
              @error('cp')    
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3 d-flex">
              ...
              <input type="text" class="form-control @error('nomor_telepon') is-invalid @enderror" id="nomor_telepon" name="nomor_telepon" required value="{{ old('nomor_telepon', $hotel->nomor_telepon) }}">
              @error('nomor_telepon')    
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3 d-flex">
              ...
              <input type="text" class="form-control @error('fax') is-invalid @enderror" id="fax" name="fax" required value="{{ old('fax', $hotel->fax) }}">
              @error('fax')    
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3 d-flex">
              ...
              <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" required value="{{ old('alamat', $hotel->alamat) }}">
              @error('alamat')    
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
