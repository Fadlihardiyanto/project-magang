...
<div class="card mb-3">
    ...
    <div class="card-body" id="hideshow">
        ...
        <div class="col-lg-7 ms-auto me-auto">
            <form method="post" action="/dashboard/dataGl">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('up') is-invalid @enderror" id="up" name="up" required value="{{ old('up') }}">
                @error('up')    
                  <div class="invalid-feedback">
                      {{ $message }}
                  </div>
              ...
              <div class="mb-3">
                ...
                <textarea type="text" class="form-control @error('catatan1') is-invalid @enderror" id="catatan1" name="catatan1" required value="{{ old('catatan1') }}"></textarea>
                @error('catatan1')    
                  <div class="invalid-feedback">
                      {{ $message }}
                  </div>
              ...
              <div class="mb-3">
                ...
                <textarea type="text" class="form-control @error('catatan2') is-invalid @enderror" id="catatan2" name="catatan2" required value="{{ old('catatan2') }}"></textarea>
                @error('catatan2')    
                  <div class="invalid-feedback">
                      {{ $message }}
                  </div>
              ...
              <div class="mb-3">
                ...
                <textarea type="text" class="form-control @error('catatan3') is-invalid @enderror" id="catatan3" name="catatan3" required value="{{ old('catatan3') }}"></textarea>
                @error('catatan3')    
                  <div class="invalid-feedback">
                      {{ $message }}
                  </div>
