...
<div class="card mb-3">
    ...
    <div class="card-body" id="hideshow">
        ...
        <div class="col-lg-7 ms-auto me-auto">
            <form method="post" action="{{ url('dashboard/manajemen/'.$user->id) }}">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" required value="{{ old('username', $user->email) }}">
                @error('email')    
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
              ...
              <select id="unitkerja_id" class="form-select" name="unitkerja_id" required>
                  ...
                  @foreach ($unitkerjas as $unitkerja)
                    @if(old('unitkerja_id', $user->unitkerja_id) == $unitkerja->id)
