...
@section('container')
    ...
    <div class="card">
        <div class="card-header fs-5 d-flex justify-content-between">
          ...
          <div class="card-body">
            <div class="col-lg-10">
              <form action="/dashboard/inputnotadinas" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control @error('jenis_perjalanan') is-invalid @enderror" id="jenis_perjalanan" name="jenis_perjalanan">
                        </div>
